...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-openlayers/node_modules/openlayers/tasks/build-ext.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-openlayers/node_modules/openlayers/tasks/build-ext.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-openlayers/node_modules/openlayers/tasks/</a> &#187; build-ext.js</div>
</div>
<div class="body">
...
function getExternalModules() {
  return pkg.ext.map(function(item) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof item === 'string') {
<span class="cstat-no" title="statement not covered" >      return {</span>
      ...
      return {
        ...
        browserify: item.browserify !== undefined ? item.browserify : <span class="branch-1 cbranch-no" title="branch not covered" >false</span>
      };
    }
  });
}
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (mod.browserify) {
...
<span class="cstat-no" title="statement not covered" >    fs.readFile(mod.main, <span class="fstat-no" title="function not covered" >function(err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        callback(err);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      callback(null, wrap(data.toString()));</span>
    });
  }
}
&nbsp;
